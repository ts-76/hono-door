/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e03791a7547a301b0c50f59f299d6c41)
// Runtime types generated with workerd@1.20260625.1 2026-06-27 nodejs_compat
interface __BaseEnv_Env {
	APP_ENV: "production";
	PUBLIC_BASE_URL: "https://hono-short-link-do.tsapp.workers.dev";
	ADMIN_API_TOKEN: string;
	PUBLIC_LINKS: DurableObjectNamespace<import("./src/index").PublicLink>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "PublicLink" | "Room" | "Registry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_BASE_URL" | "ADMIN_API_TOKEN">> {}
}
